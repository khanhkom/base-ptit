...
import { getListLichSuSuDungTaiSan } from '@networking/user';
import { Box, FlatList } from 'native-base';

import ItemLichSuSuDungTaiSan from './Items/ItemLichSuSuDungTaiSan';
import styles from './styles';

const LichSuSuDungTaiSan = (props: any) => {
  ...
  const getData = async () => {
    ...
    try {
      ...
      const res: any = await getListLichSuSuDungTaiSan(body);
...
export default LichSuSuDungTaiSan;
